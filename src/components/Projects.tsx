    ...
    <section id="projects" className="py-20 bg-gradient-to-b from-gray-50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Our Latest
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-orange-500"> Projects</span>
          </motion.h2>
          <motion.p
            variants={fadeInUp}
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <motion.button
                    className="flex items-center text-blue-600 font-semibold hover:text-orange-500 transition-colors duration-300"
                    whileHover={{ x: 5 }}
                  >
                    View Details
